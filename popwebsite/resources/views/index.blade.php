     	...
     	<div class="main-content">
     		<div class="container-fluid" style="margin: 0;padding: 0;">
    	 		<div class="intro-section " style="padding-top: 10%; padding-left: 3%; padding-right: 3%">
    	 			<div class="pull-left imageHolder visible-lg visible-md" style="background: url(assets/img/pop_tv.fw.png); width: 547px; height: 244px">
                        <img src="assets/img/people_of_power_logo.fw.png" class="img-responsive">
                    </div>
                    <div class="pull-right"><img class="img-responsive" src="assets/img/people_of_power_logo.fw.png"></div><br />
    	 		</div>
                    ...
                    <div class="container vision-watchword-team">
                        <div class="row">
                            <div class="col-xs-3 intro-with-duction">
                                <img src="assets/img/torch.fw.png" class="img-responsive">
                                <br />
